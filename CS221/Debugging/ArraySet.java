 ...
 * 
 * @param <T>
 *            type to store in the set
 * 
 * @author mvail
 */
public class ArraySet<T> implements SimpleSet<T> {
	private static final int DEFAULT_CAPACITY = 10;
	private T[] setArray; // holds current elements of the set in consecutive
							// indexes beginning with 0
	private int rear; // the next open index where a new element could be added,
						// also the size of the set
	 ...
	 *            specifies expected maximum capacity needed by the set
	 */
